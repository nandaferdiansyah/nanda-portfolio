...
const Profile = () => {
  ...
  return (
    <div
      className={clsx(
        "fixed z-20 w-full bg-neutral-50 p-5 shadow-sm dark:border-b dark:border-neutral-800 dark:bg-neutral-900 lg:relative lg:border-none lg:bg-transparent! lg:p-0 lg:shadow-none",
        isOpen && "max-h-dvh overflow-y-auto pb-0",
      )}
    >
        ...
        {isMobile && (
          <div
            className={clsx(
              ...
              isOpen && "h-[130px] flex-col-reverse !items-end justify-between pb-1",
            )}
          >
            <ThemeToggle />
